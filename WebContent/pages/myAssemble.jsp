					...
					if(!flag){
						...
						if(null == session.getAttribute("assemble")){
							...
							out.print("<div class='productItem'>");
					 		out.print("<hr>");
					        out.print("<div class='pInf'>");
					        out.print("<br>总价:" + userAssemble.getPrice() +" CNY");
					        out.print("</div>");
						    out.print("</div>");
					        ...
					        out.print("<input type='submit' value='买买买'> ");
					        out.print("</div>");
					        out.print("</form>");
					        out.print("</div>");
					        
					        out.print("<div class='pform'>");
					        out.print("<form action='../TruncateAssembleServlet' method='post'>");
					        out.print("<div class='formgroup'>");
					        out.print("<input type='submit' value='清空组装信息'> ");
					        out.print("</div>");
					        out.print("</form>");
					        out.print("</div>");
					        
					        out.print("<div class='pInf'>");
					        out.print("<a href='score.jsp'>我要评分</a>");
					        out.print("</div>");
						}
					}
